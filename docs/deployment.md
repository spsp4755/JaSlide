...
The script produces `dist/release/jaslide-v0.4.0-linux-amd64-images.tar.gz` and its SHA-256 checksum. This one archive contains the API, web, renderer, PostgreSQL, and Redis images.
...
podman tag jaslide/api:v0.4.0 harbor.example.internal/jaslide/api:v0.4.0
podman tag jaslide/web:v0.4.0 harbor.example.internal/jaslide/web:v0.4.0
podman tag jaslide/renderer:v0.4.0 harbor.example.internal/jaslide/renderer:v0.4.0
podman tag jaslide/postgres:v0.4.0 harbor.example.internal/jaslide/postgres:v0.4.0
podman tag jaslide/redis:v0.4.0 harbor.example.internal/jaslide/redis:v0.4.0
podman push harbor.example.internal/jaslide/api:v0.4.0
podman push harbor.example.internal/jaslide/web:v0.4.0
podman push harbor.example.internal/jaslide/renderer:v0.4.0
podman push harbor.example.internal/jaslide/postgres:v0.4.0
podman push harbor.example.internal/jaslide/redis:v0.4.0
```
