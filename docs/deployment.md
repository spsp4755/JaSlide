...
```bash
JASLIDE_VERSION=v0.7.0 docker compose --file docker-compose.yml --env-file .env build
JASLIDE_VERSION=v0.7.0 docker compose --file docker-compose.yml --env-file .env \
...
- `dist/release/jaslide-v0.7.0-linux-amd64-images.tar.gz`
- `dist/release/jaslide-v0.7.0-linux-amd64-images.tar.gz.sha256`
