...
```bash
./scripts/release/build-amd64-images.sh v0.5.0
# dist/release/jaslide-v0.5.0-linux-amd64-images.tar.gz
# dist/release/jaslide-v0.5.0-linux-amd64-images.tar.gz.sha256
```
